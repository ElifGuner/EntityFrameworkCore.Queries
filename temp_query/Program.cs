...
#endregion
#region Query Syntax
var urunler4 = await (from urun in context.Urunler
                     select urun).ToListAsync();
#endregion
#endregion
...
//IQueryable çalışmalarında ilgili kod yazıldığı noktada tetiklenmez/çalıştırılmaz yani ilgili kod yazıldığı noktada sorguyu generate etmez! Nerede eder?
//Çalıştırıldığı/execute edildiği noktada tetiklenir! İşte bu durumada ertelenmiş çalışma denir!
#endregion
#endregion
#endregion
...
#region Method Syntax
var urunler5 = context.Urunler.ToListAsync();
#endregion
#region Query Syntax
...
#region Method Syntax
var urunler8 = await context.Urunler.Where(u => u.Id > 500).ToListAsync();
var urunler9 = await context.Urunler.Where(u => u.UrunAdi.StartsWith("a")).ToListAsync();
Console.WriteLine();
#endregion
#region Query Syntax
...
#region Method Syntax
var urunler11 = context.Urunler.Where(u => u.Id > 500 || u.UrunAdi.EndsWith("2")).OrderBy(u => u.UrunAdi);
#endregion
#region Query Syntax
...
await urunler12.ToListAsync();
#endregion

#region ThenBy
//OrderBy üzerinde yapılan sıralama işlemini farklı kolonlarada uygulamamızı sağlayan bir fonksiyondur. (Ascending) 

var urunler13 = context.Urunler.Where(u => u.Id > 500 || u.UrunAdi.EndsWith("2")).OrderBy(u => u.UrunAdi).ThenBy(u => u.Fiyat).ThenBy(u => u.Id);

await urunler13.ToListAsync();
#endregion
...
//Sorgulama neticesinde elde edilen koleksiyonel veriler üzerinde iterasyonel olarak dönmemizi ve teker teker
